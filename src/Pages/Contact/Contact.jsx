  ...
  return (
    <div id="contact" style={{height:"auto",
      ...
      <Text fontSize={{base:"15px", sm:"18px",md:"20px"}} 
            ...
            textShadow="2px 2px 10px rgb(250 200 100)">Shakil Pendhari</Text>
      <Text  fontSize={{base:"13px", sm:"16px",md:"18px"}} 
             fontWeight="700"
             textShadow="2px 2px 10px rgb(200 150 100)">call: 919921317929</Text>
      <Flex  
                gap="1rem"
                width="20%"
      ...
      <Text fontWeight="700"
            textShadow="2px 2px 10px rgb(250 200 100)">Thank you</Text>
    </div>
  )
}
